...
GO
/*
The type for column EPS in table [dbo].[EPS_Diluted] is currently  FLOAT (53) NOT NULL but is being changed to  MONEY NOT NULL. Data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[EPS_Diluted])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[EPS_Diluted]...';


GO
ALTER TABLE [dbo].[EPS_Diluted] ALTER COLUMN [EPS] MONEY NOT NULL;
